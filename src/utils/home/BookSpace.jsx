...
import { LINKS, KLink } from "@/components/seoLinks";

// ── Activity data — href added to each item for SEO internal linking ─────────
const activitiesData = [
  ...
  },
  {
    ...
    imageSrc:
      "https://images.unsplash.com/photo-1606983340126-99ab4feaa64a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2148&q=80",
    location: "Delhi NCR",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    imageSrc:
      "https://images.unsplash.com/photo-1559028006-448665bd7c7f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2136&q=80",
    location: "Noida, Delhi",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-1/2 lg:pr-12">
        ...
        >
          A{" "}
          <KLink href={LINKS.venues} className="text-black">
            space
          </KLink>{" "}
          for <br /> every moment
        </motion.h1>
        ...
        >
          Book a unique{" "}
          <KLink href={LINKS.venues} className="text-gray-800">
            space
          </KLink>{" "}
          for your activity with{" "}
          <KLink href={LINKS.home} className="text-gray-800">
            Effortless Events
          </KLink>
          .
        </motion.p>
          ...
          {activitiesData.map((item, index) => (
            ...
            >
              ...
              >
                {/* Arrow */}
                <motion.div
                  className={`transition-colors duration-500 ${hoveredId === item.id ? "text-black" : "text-gray-400"}`}
                  animate={{
                ...
                <div className="flex-1 min-w-0">
                  {/* Activity title — linked to filtered search */}
                  <motion.h3
                  ...
                  >
                    <p className="text-gray-600 text-sm leading-relaxed pr-2">
                      ...
                      <a
                        href={item.href}
                        className="text-black font-medium underline underline-offset-2 decoration-dotted hover:decoration-solid"
                      >
                        Browse {item.activity} venues →
                      </a>
                    </p>
      ...
      <div className="w-full lg:w-1/2 mt-12 lg:mt-0">
        <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px]">
          <motion.div
            ...
            exit={{ scale: 0.95, rotateY: -5, transition: { duration: 0.4 } }}
            className="absolute inset-0 w-full h-full"
          >
            {/* Wrap image in a link to the relevant search page */}
            <a
              href={activeItem.href}
              aria-label={`View ${activeItem.activity} venues`}
            >
              <motion.img
                src={activeItem.imageSrc}
                alt={`${activeItem.activity} venue – Effortless Events`}
            ...
            <motion.div
              ...
              className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent p-8 rounded-b-2xl pointer-events-none"
            >
              <motion.p
