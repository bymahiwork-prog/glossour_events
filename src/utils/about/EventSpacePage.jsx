    ...
    <section className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-0 hidden lg:block z-10 pointer-events-none">
        ...
        <img
          src="about4.png"
          alt="Wedding mandap"
          className="absolute bottom-28 right-[30%] w-80 h-60 object-cover rounded-3xl shadow-2xl border border-[#C9A34A]/40 rotate-[-3deg]"
        />
        ...
        <img
          src="about5.png"
          alt="Outdoor venue"
          className="absolute bottom-32 right-8 w-80 h-60 object-cover rounded-3xl shadow-2xl border border-[#C9A34A]/40 rotate-[4deg]"
        />
      </div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto min-h-screen flex items-center px-6 lg:px-12 pt-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-base md:text-lg text-gray-300 leading-8 max-w-xl mb-8">
              Effortless Events Pvt. Ltd. is a Delhi NCR-based event planning
              and venue management company specializing in weddings, corporate
              events, and private celebrations with end-to-end services
              including venue selection, décor, catering, and event
              coordination.
            </p>
            ...
            <a
              ...
              className="inline-flex items-center bg-[#C9A34A] hover:bg-[#b8923d] text-black font-semibold px-8 py-4 rounded-2xl shadow-xl transition-colors duration-300"
            >
              Plan Your Event on WhatsApp
            </a>
          </div>

          {/* Empty Right Column for Image Layout Balance */}
