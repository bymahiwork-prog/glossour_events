          ...
          <div className="lg:col-span-1">
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 sticky top-4">
              ...
              <div className="mb-4 sm:mb-6">
                ...
                <div className="text-xs sm:text-sm text-[#8559EC]">onwards</div>
              </div>
              ...
              <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                <div>
                  ...
                  <select
                    ...
                    className="w-full text-black px-2 sm:px-3 py-2 sm:py-2.5 lg:py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8559EC] focus:border-[#8559EC] text-xs sm:text-sm lg:text-base appearance-none bg-white cursor-pointer transition-all duration-200 hover:border-gray-400"
                    style={{
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3 text-black">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-2 sm:px-3 py-2 sm:py-2.5 lg:py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#8559EC] focus:border-[#8559EC] text-xs sm:text-sm lg:text-base appearance-none bg-white cursor-pointer transition-all duration-200 hover:border-gray-400"
                      style={{
                        backgroundImage: `url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 20 20'%3e%3cpath stroke='%236b7280' stroke-linecap='round' stroke-linejoin='round' stroke-width='1.5' d='m6 8 4 4 4-4'/%3e%3c/svg%3e")`,
              ...
              <button
                ...
                className="w-full bg-[#8559EC] text-white py-2.5 sm:py-3 lg:py-3.5 px-4 rounded-md font-medium hover:bg-purple-700 active:bg-purple-800 transition-colors mb-3 sm:mb-4 text-xs sm:text-sm lg:text-base shadow-sm hover:shadow-md transform active:scale-[0.98] transition-all duration-200"
              >
                Start Booking
              </button>
