  ...
  const venues = [
    {
      ...
      description: "Farm features a spacious venue capable of accommodating approximately 20 to 500 guests, providing an excellent setting for your wedding..."
    },
    {
      id: 2,
      name: "Effortless Farm45",
  ...
  const reviews = [
    {
      id: 1,
      author: "J.B.",
      venue: "Fatima/Union Square Classic NY Loft with High Ceilings, Filled with Light",
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {venues.map((venue, index) => (
            <div key={venue.id} className="bg-white overflow-hidden shadow-sm border border-gray-200">
              {/* Venue Image */}
